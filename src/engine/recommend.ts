import { compScore, counterScore, finalScore, metaScore, synergyScore } from './score';
...
export function recommend(inp: RecommendInput): Rec[] {
  ...
  return inp.pool
    ...
    .map((h) => {
      ...
      const sy = synergyScore(h.id, inp.allies, inp.syn);
      ...
      return { hero: h.id, score, reasons, breakdown: b, counters: c.counters, allies: sy.allies };
    })
